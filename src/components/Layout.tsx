...
const Layout = ({ children }) => {
  ...
  const [isMenuSelected, setMenuStatus] = useState<boolean>(false);

  return (
    <>
      <header className="py-6 md:py-12">
        {/* menu slider  */}
        <div className="flex justify-between px-2 py-3 align-middle items-center md:hidden">
          <div>
            <Link href="/">
          ...
          <div
            className={
              isMenuSelected
                ? `w-[300px] fixed top-0 right-0 bottom-0 translate-x-0 bg-white z-10 drop-shadow-lg px-2 transition-all ease-in-out`
                : `w-[300px] fixed top-0 right-0 bottom-0 bg-white z-10 drop-shadow-lg translate-x-full px-2 transition-all ease-in-out`
            }
          >
            <div className="flex justify-end items-center align-middle py-4 px-4">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6"
                fill="none"
            ...
            <div className="py-4">
              <Link href="/">
                <a className="flex flex-col py-2 items-center text-gray-900">
                  <div className="rounded-full w-12 h-12 flex items-center justify-center mr-4">
                    <svg
                      className="w-full h-full fill-current"
                      viewBox="0 0 70 70"
            ...
            <div className="pt-6 space-y-4 px-2 divide-y-2">
              <ul className="space-y-2 pb-4">
                <li className="snipcart-customer-signin flex justify-start align-baseline items-start space-x-2">
                  {" "}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                ...
                <Link href="/wishlist">
                  <a className="flex justify-start align-baseline items-start space-x-2">
                ...
                <li className="snipcart-checkout flex justify-start align-baseline items-start space-x-2">
                  <div className="relative">
                    {cartHasItems && (
